...
informative_names <- zspp_aic %>% 
  ...
  mutate(mod.name.out = ifelse(Modnames == "intercept", "Intercept only", mod.name.inf),
         mod.name.out = gsub("moci", "MOCI", mod.name.out),
         mod.name.out = gsub("fresh", "freshwater inflow", mod.name.out),
         mod.name.out = gsub("poly\\(study.year, 2\\)1", "Year", mod.name.out),
         mod.name.out = gsub("poly\\(study.year, 2\\)2", "^2^", mod.name.out),
         mod.name.out = gsub("study.year", "Year", mod.name.out),
